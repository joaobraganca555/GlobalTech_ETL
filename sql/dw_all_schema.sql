...
(
  [order_id] int,
  [sk_warehouse] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_warehouse(sk_warehouse),
  [sk_product] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_product(sk_product),
  [sk_customer] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_customer(sk_customer),
  [sk_date] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_date(sk_date),
  [sk_employee] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_employee(sk_employee),
  [status] varchar(20) NOT NULL,
...
(
  ...
  [sk_order_date] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_date(sk_date),
  [sk_limit_payment_date] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_date(sk_date),
  [sk_employee] int NOT NULL FOREIGN KEY REFERENCES dw.DIM_employee(sk_employee),
