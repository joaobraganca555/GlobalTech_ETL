...
CREATE TABLE [DW].[DateDimension](
	...
	[Day of Week English] [nvarchar](20) NOT NULL,
	[Day of Week Portuguese] [nvarchar](30) NOT NULL,
	[Day of Week Number] [int] NOT NULL,
	[Week of Year] [nvarchar](5) NOT NULL,
	[Month English] [nvarchar](10) NOT NULL,
	[Month Portuguese] [nvarchar](10) NOT NULL,
	...
	[Portuguese Holiday Flag] [tinyint] NOT NULL,
